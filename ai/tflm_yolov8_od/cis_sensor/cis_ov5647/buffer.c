...
__attribute__(( section(".bss.NoInit"))) uint8_t raw_buff_320_320[(int)320*320] __ALIGNED(32);
__attribute__(( section(".bss.NoInit"))) uint8_t raw_buff_320_320_rgb[(int)320*320] __ALIGNED(32);
